...
.dashboard-content .header-search { height:44px; width:280px; border-color:#e0e8f2; border-radius:12px; background:#fff; }
.dashboard-content .header-clock, .dashboard-content .dark-toggle { height:44px; border-color:#e0e8f2; background:#fff; box-shadow:0 5px 16px rgba(29,59,101,.04); }
.dashboard-content .profile-control { padding:4px 11px 4px 5px; border-radius:12px; border-color:#e0e8f2; box-shadow:0 5px 16px rgba(29,59,101,.04); }
.dashboard-content .profile-control .avatar { width:34px; height:34px; color:#fff; background:linear-gradient(135deg,#1e40af,#3b82f6); }
