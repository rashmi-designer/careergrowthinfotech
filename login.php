...
@media (min-width:769px){
    .login-card{position:relative;isolation:isolate;width:min(100%,380px);max-width:380px;padding:24px 26px;overflow:hidden;border:1px solid transparent;border-radius:24px;background:linear-gradient(145deg,rgba(8,56,111,.66),rgba(8,87,121,.45)) padding-box,linear-gradient(145deg,rgba(173,244,255,.98),rgba(52,213,236,.72) 42%,rgba(38,180,207,.34) 78%,rgba(143,246,222,.9)) border-box;box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 22px rgba(101,220,255,.08),0 0 0 1px rgba(20,216,218,.14),0 0 28px rgba(41,219,228,.2),0 20px 46px rgba(0,20,63,.4);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}
